...
class TwitterAuthRepository {
    ...
    async createUserWeb(userData) {
        try {
            ...
            const user = await User_1.default.create({
                userId: (0, uuid_1.v4)(), // Automatically generate userId
    ...
    async updateUserWeb(id, userData) {
        try {
    ...
    async updateUserSocialHandle(id, data) {
        try {
            const socialHandle = await UserSocialHandle_1.default.findByPk(id);
            if (!socialHandle)
                return null;
...
exports.default = new TwitterAuthRepository();
